...
export default function TeacherExamsMarks({
    exam,
    schedules,
    currentSchedule,
    ...
    return (
        <>
            <Head title={`Input Marks — ${exam.title}`} />
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6 max-w-5xl">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">Input Marks: {exam.title}</h1>
                        <p className="text-xs text-muted-foreground mt-0.5">
                            Submit student scores for your assigned subjects.
                        </p>
                    </div>
                </div>
                ...
                {currentSchedule ? (
                        ...
                        <div className="bg-card border rounded-xl overflow-hidden shadow-sm">
                            <div className="p-4 bg-muted/20 border-b flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                ...
                                <Button type="submit" disabled={saving} size="sm" className="gap-1.5 self-end">
                                    ...
                                    {saving ? 'Saving...' : 'Save Subject Marks'}
                                </Button>
                            </div>
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b bg-muted/40 text-xs text-muted-foreground uppercase">
                                            ...
                                            <th className="px-4 py-3 text-center">Marks (0 – {currentSchedule.total_marks})</th>
                                            <th className="px-4 py-3 text-center">Attendance</th>
                                            <th className="px-4 py-3 text-left">Teacher Note</th>
                                        </tr>
                                    </thead>
                    ...
                    <div className="text-center py-12 text-sm text-muted-foreground">
                        No assigned subject schedule available.
                    </div>
                )}
            </div>
        </>
...
TeacherExamsMarks.layout = {
    breadcrumbs: [
        { title: 'Dashboard', href: '/teacher/dashboard' },
        { title: 'Exams & Marks', href: '/teacher/exams' },
        { title: 'Input Marks', href: '#' },
    ],
};
